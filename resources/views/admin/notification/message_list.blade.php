                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach ($messages as $message)
                            <tr class="bg-{{$message->status==0?'light':''}}">
                                ...
                                <td>{{substr($message->user_desp, 0, 15)}}..</td>
                                <td>
                                    <div class="dropdown mb-3">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{route('message.view', $message->id)}}" class="dropdown-item">View</a>
                                            <a href="{{route('message.delete', $message->id)}}" class="dropdown-item">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
